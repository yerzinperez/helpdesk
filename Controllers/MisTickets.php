<?php
     ...
     */
    class MisTickets extends Controllers{
        ...
        public function misTickets(){
            $data['page_title'] = "Mis Tickets";
            $data['page_functions'] = media() . "js/tickets/misTickets.js";
            $this->views->getView($this, "misTickets", $data);
        }
