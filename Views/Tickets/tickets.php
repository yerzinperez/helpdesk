		...
		<section class="tabs-section">
			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane fade in active show" id="tabs-2-tab-1">
					<table id="tblTicketsAbiertos" class="display table table-bordered" cellspacing="0" width="100%">
						<thead>
							<tr>
								<th>#</th>
								<th>Título</th>
				...
				<div role="tabpanel" class="tab-pane fade" id="tabs-2-tab-2">
					<table id="tblTicketsAtrasados" class="display table table-bordered" cellspacing="0" width="100%">
						<thead>
							<tr>
								<th>#</th>
								<th>Título</th>
				...
				<div role="tabpanel" class="tab-pane fade" id="tabs-2-tab-3">
					<table id="tblTicketsCerrados" class="display table table-bordered" cellspacing="0" width="100%">
						<thead>
							<tr>
								<th>#</th>
								<th>Título</th>
